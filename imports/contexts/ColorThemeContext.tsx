...
export const ColorThemeProvider: React.FC<ColorThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--color-culture', '#e99d48');
    ...
    root.style.setProperty('--gradient-culture', 'linear-gradient(135deg, #e99d48 0%, #ff8534 100%)');
