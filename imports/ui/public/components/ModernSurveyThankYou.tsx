...
// Import Google Fonts for script font
...
const formatTime = (timeInSeconds: number): string => {
  if (!timeInSeconds) return '00:00sec';
  
  const minutes = Math.floor(timeInSeconds / 60);
  const seconds = Math.floor(timeInSeconds % 60);
  
  // Format as MM:SSsec like in Figma
...
const ModernSurveyThankYou: React.FC<ModernSurveyThankYouProps> = ({ 
  ...
  const effectiveColor = color || survey.color || '#552a47'; // Default to purple if no color provided
  ...
  useEffect(() => {
    // Hide the header when thank you screen is displayed
  ...
  useEffect(() => {
    ...
    style.textContent = `
      :root {
        ...
        --primary-color-light: ${effectiveColor}20;
        --button-hover: ${adjustColor(effectiveColor, -20)};
        --text-color: #4b5563;
      }
    `;
  ...
  return (
    <ThankYouContainer primaryColor={effectiveColor}>
      <ThankYouHeader>
        <ThankYouIcon>
          <img 
        ...
        {survey.thankYouBoxes && survey.thankYouBoxes.length > 0 ? (
            ...
            .map((box, index) => {
              ...
              return (
                <StatCard key={`thank-you-box-${index}`}>
                  ...
                  <StatContent>
                    <StatValue style={originalIndex === 3 ? { fontSize: '48px' } : {}}>
          ...
          <>
            <StatCard>
              ...
              <StatContent>
                <StatValue primaryColor={effectiveColor}>{answeredQuestions}</StatValue>
                <StatLabel primaryColor={effectiveColor}>TOTAL RESPONSES</StatLabel>
            ...
            <StatCard>
              ...
              <StatContent>
                <StatValue primaryColor={effectiveColor}>{currentResponseData.unansweredQuestions || 0}</StatValue>
                <StatLabel primaryColor={effectiveColor}>UNANSWERED QUESTIONS</StatLabel>
            ...
            <StatCard>
              ...
              <StatContent>
                <StatValue primaryColor={effectiveColor}>{completionPercentage}%</StatValue>
                <StatLabel primaryColor={effectiveColor}>COMPLETION</StatLabel>
            ...
            <StatCard>
              ...
              <StatContent>
                <StatValue primaryColor={effectiveColor} style={{ fontSize: '48px' }}>{formatTime(surveyTime)}</StatValue>
                <StatLabel primaryColor={effectiveColor}>TIME TAKEN</StatLabel>
