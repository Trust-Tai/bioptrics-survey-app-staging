...
const Welcome: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '80vh', justifyContent: 'center' }}>
      ...
      <button style={{ padding: '1em 2em', fontSize: 18, background: 'var(--color-primary, #552a47)', color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer' }} onClick={() => navigate('/survey')}>
        Next
      </button>
    </div>
  );
