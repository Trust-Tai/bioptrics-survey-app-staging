...
/**
 * Interface for comment cluster data used in the comment cluster view
 */
...
/**
 * Props for the CommentClusterView component
 */
export interface CommentClusterViewProps {
...
/**
 * CommentClusterView component for displaying and searching through comment clusters
 * Groups comments by theme and allows filtering by search term
 */
