...
/**
 * Interface for issue data used in the flagged issues list
 */
...
/**
 * Props for the FlaggedIssuesList component
 */
export interface FlaggedIssuesListProps {
  issues: Issue[];
  isLoading: boolean;
  isBlurred: boolean;
}
...
/**
 * FlaggedIssuesList component for displaying flagged issues in the analytics dashboard
 * Issues are color-coded by severity and include appropriate icons
 */
