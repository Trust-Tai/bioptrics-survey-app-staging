    ...
    <div style={{
      ...
      <div style={{
        ...
        {question.description && (
          <div 
            style={{ marginBottom: 12, color: '#6e5a67', fontSize: 15 }} 
        ...
        {question.answerType === 'long_text' && (
          <div style={{ marginBottom: 10, color: '#888', fontSize: 15 }}>
            <em>Long text answer preview</em>
          </div>
        )}
        {question.answerType === 'short_text' && (
          <div style={{ marginBottom: 10, color: '#888', fontSize: 15 }}>
            <em>Short text answer preview</em>
          </div>
        )}
        {question.feedbackType && question.feedbackType !== 'none' && (
          <div style={{ marginTop: 18, padding: '10px 0 0 0', borderTop: '1px solid #e0e0e0' }}>
            ...
            {question.feedbackType === 'text' && question.feedbackValue && (
              <div style={{ marginTop: 4, color: '#6e5a67', fontSize: 15 }}>
                Prompt: {question.feedbackValue}
              </div>
            )}
          </div>
        )}
