			...
			<div style={{ padding: 20 }}>
				<div style={{ marginBottom: 20 }}>
					...
					<div style={{ marginBottom: 12 }}>
								...
								onChange={() => {
									...
									const updatedSurvey = {
										...
										defaultSettings: {
											...
											maxResponses: !currentValue ? (defaultSettings.maxResponses || 100) : undefined,
										},
									};
									setSurvey(updatedSurvey);
									setHasUnsavedChanges(true);
						...
						<div style={{ marginLeft: 24, fontSize: 14, color: '#666', marginTop: 4 }}>
							Set a maximum number of responses allowed for this survey
						</div>
							...
							<div style={{ marginLeft: 24, marginTop: 12, padding: 12, backgroundColor: '#f9f9f9', borderRadius: 8, border: '1px solid #e2e8f0' }}>
								...
								<div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
									<input
										type="number"
										min="1"
										value={survey?.defaultSettings?.maxResponses || ''}
										onChange={(e) => {
									...
									<span style={{ fontSize: 14, color: '#666' }}>
										{survey?.defaultSettings?.maxResponses ? `responses` : 'responses (unlimited if empty)'}
									</span>
								</div>
