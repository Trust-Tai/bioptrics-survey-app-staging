...
// Define the SurveySectionItem interface directly to avoid circular dependencies
...
const SurveyAnalytics: React.FC<SurveyAnalyticsProps> = ({
  ...
  const [sections, setSections] = useState<SurveySectionItem[]>(propSections || []);
  const [isLoading, setIsLoading] = useState(initialLoading);
  
  // Fetch sections data if not provided as props
  useEffect(() => {
    ...
    setIsLoading(true);
    // In a real app, you would fetch sections from the server
